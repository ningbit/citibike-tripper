...
class CommutesControllerTest < ActionController::TestCase
  ...
  test "should create commute" do
    assert_difference('Commute.count') do
      post :create, commute: { end: @commute.end, end_time: @commute.end_time, name: @commute.name, start: @commute.start, start_time: @commute.start_time, user_id: @commute.user_id }
    end
  ...
  test "should update commute" do
    put :update, id: @commute, commute: { end: @commute.end, end_time: @commute.end_time, name: @commute.name, start: @commute.start, start_time: @commute.start_time, user_id: @commute.user_id }
    assert_redirected_to commute_path(assigns(:commute))
  end
